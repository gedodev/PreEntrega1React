            ...
            <nav className="navbar">
                    <ul className="nbUl">
                        <li className="nbTitle"> 
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-books" width="64" height="64" viewBox="0 0 24 24" stroke-width="1.5" stroke="#EEE" fill="none" stroke-linecap="round" stroke-linejoin="round">
